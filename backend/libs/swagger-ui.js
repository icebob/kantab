/*
	Swagger UI provider module.

	The file is copied from "swagger-ui-express" library.
	Modifications:
		- remove "express" dependency
		- remove Express-related function calls to work with moleculer-web
*/
